...
nonisolated struct Securegcm_GcmDeviceInfo: @unchecked Sendable {
  ...
  var hasAndroidDeviceID: Bool {_storage._androidDeviceID != nil}
  ...
  var hasGcmRegistrationID: Bool {_storage._gcmRegistrationID != nil}
  ...
  var hasApnRegistrationID: Bool {_storage._apnRegistrationID != nil}
  ...
  var hasNotificationEnabled: Bool {_storage._notificationEnabled != nil}
  ...
  var hasBluetoothMacAddress: Bool {_storage._bluetoothMacAddress != nil}
  ...
  var hasDeviceMasterKeyHash: Bool {_storage._deviceMasterKeyHash != nil}
  ...
  var hasUserPublicKey: Bool {_storage._userPublicKey != nil}
  ...
  var hasKeyHandle: Bool {_storage._keyHandle != nil}
  ...
  var hasCounter: Bool {_storage._counter != nil}
  ...
  var hasDeviceOsVersion: Bool {_storage._deviceOsVersion != nil}
  ...
  var hasDeviceOsVersionCode: Bool {_storage._deviceOsVersionCode != nil}
  ...
  var hasDeviceOsRelease: Bool {_storage._deviceOsRelease != nil}
  ...
  var hasDeviceOsCodename: Bool {_storage._deviceOsCodename != nil}
  ...
  var hasDeviceSoftwareVersion: Bool {_storage._deviceSoftwareVersion != nil}
  ...
  var hasDeviceSoftwareVersionCode: Bool {_storage._deviceSoftwareVersionCode != nil}
  ...
  var hasDeviceSoftwarePackage: Bool {_storage._deviceSoftwarePackage != nil}
  ...
  var hasDeviceDisplayDiagonalMils: Bool {_storage._deviceDisplayDiagonalMils != nil}
  ...
  var hasDeviceAuthzenVersion: Bool {_storage._deviceAuthzenVersion != nil}
  ...
  var hasLongDeviceID: Bool {_storage._longDeviceID != nil}
  ...
  var hasDeviceManufacturer: Bool {_storage._deviceManufacturer != nil}
  ...
  var hasUsingSecureScreenlock: Bool {_storage._usingSecureScreenlock != nil}
  ...
  var hasAutoUnlockScreenlockSupported: Bool {_storage._autoUnlockScreenlockSupported != nil}
  ...
  var hasAutoUnlockScreenlockEnabled: Bool {_storage._autoUnlockScreenlockEnabled != nil}
  ...
  var hasBluetoothRadioSupported: Bool {_storage._bluetoothRadioSupported != nil}
  ...
  var hasBluetoothRadioEnabled: Bool {_storage._bluetoothRadioEnabled != nil}
  ...
  var hasMobileDataSupported: Bool {_storage._mobileDataSupported != nil}
  ...
  var hasTetheringSupported: Bool {_storage._tetheringSupported != nil}
  ...
  var hasBleRadioSupported: Bool {_storage._bleRadioSupported != nil}
  ...
  var hasPixelExperience: Bool {_storage._pixelExperience != nil}
  ...
  var hasArcPlusPlus: Bool {_storage._arcPlusPlus != nil}
  ...
  var hasIsScreenlockStateFlaky: Bool {_storage._isScreenlockStateFlaky != nil}
  ...
  var hasEnrollmentSessionID: Bool {_storage._enrollmentSessionID != nil}
  ...
  var hasOauthToken: Bool {_storage._oauthToken != nil}
...
nonisolated struct Securegcm_GcmMetadata: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Securegcm_Tickle: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Securegcm_LoginNotificationInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated fileprivate let _protobuf_package = "securegcm"
