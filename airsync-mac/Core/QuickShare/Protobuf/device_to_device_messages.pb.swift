...
nonisolated struct Securegcm_DeviceToDeviceMessage: Sendable {
...
nonisolated struct Securegcm_InitiatorHello: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasPublicDhKey: Bool {self._publicDhKey != nil}
...
nonisolated struct Securegcm_ResponderHello: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Securegcm_EcPoint: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasCurve: Bool {self._curve != nil}
...
nonisolated struct Securegcm_SpakeHandshakeMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasFlowNumber: Bool {self._flowNumber != nil}
  ...
  var hasEcPoint: Bool {self._ecPoint != nil}
