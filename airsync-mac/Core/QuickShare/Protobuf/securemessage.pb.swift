...
nonisolated struct Securemessage_SecureMessage: Sendable {
  ...
  var hasHeaderAndBody: Bool {self._headerAndBody != nil}
...
nonisolated struct Securemessage_Header: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasSignatureScheme: Bool {self._signatureScheme != nil}
  ...
  var hasEncryptionScheme: Bool {self._encryptionScheme != nil}
  ...
  var hasDecryptionKeyID: Bool {self._decryptionKeyID != nil}
  ...
  var hasPublicMetadata: Bool {self._publicMetadata != nil}
  ...
  var hasAssociatedDataLength: Bool {self._associatedDataLength != nil}
...
nonisolated struct Securemessage_HeaderAndBody: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Securemessage_HeaderAndBodyInternal: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Securemessage_EcP256PublicKey: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Securemessage_SimpleRsaPublicKey: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Securemessage_DhPublicKey: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Securemessage_GenericPublicKey: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasEcP256PublicKey: Bool {self._ecP256PublicKey != nil}
  ...
  var hasRsa2048PublicKey: Bool {self._rsa2048PublicKey != nil}
  ...
  var hasDh2048PublicKey: Bool {self._dh2048PublicKey != nil}
...
nonisolated fileprivate let _protobuf_package = "securemessage"
