...
nonisolated struct Securegcm_Ukey2Message: Sendable {
  ...
  var hasMessageType: Bool {self._messageType != nil}
  ...
  var hasMessageData: Bool {self._messageData != nil}
...
nonisolated struct Securegcm_Ukey2Alert: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Securegcm_Ukey2ClientInit: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasRandom: Bool {self._random != nil}
  ...
  var hasNextProtocol: Bool {self._nextProtocol != nil}
  ...
  /// cipher
  nonisolated struct CipherCommitment: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    var hasHandshakeCipher: Bool {self._handshakeCipher != nil}
...
nonisolated struct Securegcm_Ukey2ServerInit: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Securegcm_Ukey2ClientFinished: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
